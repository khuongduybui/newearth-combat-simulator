...
(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        define('numeral/numeral',factory);
...
define('numeral',['numeral/numeral'],function(m){return m;});
...
function _aureliaConfigureModuleLoader(){requirejs.config({
  ...
  "bundles": {
    "app-bundle": [
      ...
      "text!app.css",
      "text!app.html",
      "elements/aurelia-console",
      "text!elements/aurelia-console.css",
      "text!elements/aurelia-console.html",
      "environment",
      "main",
      "resources",
      "resources/index"
